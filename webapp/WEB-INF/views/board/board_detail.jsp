       ...
       <div class="card-wrap">
         <div class="card">
           <div class="card-image">
             ...
             <input type="hidden" name="no1" value="${ReplyDTO.no }" />
           ...
           <div class="card-content">
             <div class="media">
               ...
               <div class="media-content">
                 <p class="title is-4">${boardDTO.id}</p>
               </div>
             </div>
             <div class="content">
             ...
             <!-- 0721 박지현, 전재영 -->
                <c:if test="${boardDTO.id==loginUser.id}">
                   ...
                   <a href="${path }" class="button is-danger is-light">삭제</a>
                </c:if>   
                   <a href="${path }/board/replyInsert" class="button is-warning is-light">댓글</a>   
             <!-- 0721 박지현, 전재영 -->
             </div>
           </div>
         </div>
              ...
              <div class="card">
                  <div class="card-content">
                     ...
                     <div class="content">
                       ...
                       <div>
                          <a href="${path }/board/replyDel" class="button is-danger is-light">댓글삭제</a>
                       </div>
                   </div>   
               </div>
           </div>    
